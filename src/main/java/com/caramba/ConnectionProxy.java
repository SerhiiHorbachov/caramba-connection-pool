...
public class ConnectionProxy implements Connection {
    ...
    public void close() throws SQLException {
        log.info(String.format("Releasing connection, available connections in the pool: %d...", connectionPool.size()));
        connectionPool.add(this);
        log.info(String.format("...connection released, available connections in the pool: %d", connectionPool.size()));
    }
